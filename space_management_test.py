    ...
    def test_member_management_endpoints(self):
        ...
        try:
            ...
            if block_response.status_code == 200:
                ...
                if verify_response.status_code == 200:
                    members = verify_response.json()
                    blocked_member = next((m for m in members if m.get('user_id') == self.blocked_user_id), None)
            ...
            if unblock_response.status_code == 200:
                ...
                if verify_response.status_code == 200:
                    members = verify_response.json()
                    unblocked_member = next((m for m in members if m.get('user_id') == self.blocked_user_id), None)
            ...
            if promote_response.status_code == 200:
                ...
                if verify_response.status_code == 200:
                    members = verify_response.json()
                    promoted_member = next((m for m in members if m.get('user_id') == self.regular_user_id), None)
            ...
            if demote_response.status_code == 200:
                ...
                if verify_response.status_code == 200:
                    members = verify_response.json()
                    demoted_member = next((m for m in members if m.get('user_id') == self.regular_user_id), None)
